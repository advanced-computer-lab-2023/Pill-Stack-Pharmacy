...
const {viewPharmacistApp,getAvailableMedicines,searchMedicineA,viewAllApp,addAdmin,viewPatientDet, PatientDetailsResults,removeUser, filterMedicinesByMedicinalUse} = require('../Routes/adminController.js');
